...
export declare class R {
    static set(metadataKey: any, metadataValue: any, target: Object, propertyKey?: string | symbol | undefined): void;
    static get<T extends any>(metadataKey: any, target: Object, propertyKey?: string | symbol | undefined): T;
    static createCustomRouteArg(paramType: string, index: number, pipes?: any[], data?: any): any;
    static createRouteArg(paramTypes: RouteParamtypes, index: number, pipes?: any[], data?: any): any;
